...
def tokenizeFiles(name, matchString):
    with open(name, 'rb') as f1818file, \
            open('../collChunk-13/1823_fullFlat_' + matchString, 'rb') as f1823file, \
            open('../collChunk-13/Thomas_fullFlat_' + matchString, 'rb') as fThomasfile, \
            open('../collChunk-13/1831_fullFlat_' + matchString, 'rb') as f1831file, \
            open('../collChunk-13/msColl_' + matchString, 'rb') as fMSfile:
...
for name in glob.glob('../collChunk-13/1818_fullFlat_*'):
    try:
